...
const DeployContractContract = () => {
  const router = useRouter();
  const contractType = useSingleQueryParam("contractType");
...
function useDeployForm(deploySchema) {
...
const ContractDeployForm = ({contract, contractType}) => {
  ...
  function isRequired(name) {
    return name in contract.schema.deploy.shape
      ? !contract.schema.deploy.shape[name].isOptional(): true;
  }
