...
export const SnapshotUpload = ({
  ...
  const [validAddresses, setValidAddresses] = useState(initialValue);
    ...
    (acceptedFiles) => {
      ...
      Papa.parse(csv, {
        ...
        complete: (results) => {
          const addresses = [
            ...new Set(
              results.data.map((r) => Object.values(r)).flat(),
            ),
...
const SnapshotTable = ({ data, portalRef }) => {
